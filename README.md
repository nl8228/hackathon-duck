# hackathon-duck
This project consisted of making an alarm with the shape of a duck. The duck would be made with a 3d printed model, Rasberry PI, and speaker. 
...
oldbackend.py is the old logic that works with the UI in app.py
